...
<header>
      <div class="content">
         <div class="menu container">
            ...
            <nav class="navbar">
               <ul>
                  <li><a href="../TablasBDD/TablaProf.php">Inicio</a></li>
...
<div class="CajaTab">
    ...
    <!-- Aquí van los botones para Ingresar y elimianar datos -->
    <div class="editDate">
        <!-- Añadir datos -->
        <svg id="openDialogButton" xmlns="http://www.w3.org/2000/svg" class="icon2 icon-tabler icon-tabler-pencil-plus" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <!-- Eliminar datos -->
        <svg id="openDeleteDialogButton" xmlns="http://www.w3.org/2000/svg" class="icon2 icon-tabler icon-tabler-trash" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ff2825" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M4 7l16 0" />
            <path d="M10 11l0 6" />
            <path d="M14 11l0 6" />
