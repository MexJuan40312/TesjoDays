...
<header>
      <div class="content">
         <div class="menu container">
            ...
            <nav class="navbar">
               <ul>
                  <li><a href="../TablasBDD/TablaCarrera.php">Inicio</a></li>
...
<div class="CajaTab">
    ...
    <div class="editDate">
        <!-- Añadir datos -->
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil-plus" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
