...
<header>
      <div class="content">
         <div class="menu container">
            ...
            <nav class="navbar">
               <ul>
                  <li><a href="../consultas_JefeDeDivision/consulta4.php">Inicio</a></li>
   ...
   <?php
    ...
    $query = "SELECT j.Nombre, j.Apellido_Pat, j.Apellido_Mat, j.Numero_Cel, c.Nombre as Nombre_Carrera
              FROM Jefatura_Division j
              INNER JOIN Carrera c ON j.Carrera_ID = c.Carrera_ID";
...
<div class="CajaTab">
    <div class="buscador">
        <h2 class="titu">Jefes de División y sus respectivas carreras</h2>
