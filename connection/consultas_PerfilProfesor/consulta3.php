...
<header>
      <div class="content">
         <div class="menu container">
            ...
            <nav class="navbar">
               <ul>
                  <li><a href="../consultas_PerfilProfesor/consulta3.php">Inicio</a></li>
   ...
   <?php
    ...
    $query = "SELECT p.Num_Control, p.Nombre, p.Apellido_Pat, p.Apellido_Mat, permiso.Aplica, dia.Fecha, permiso.Razon_Permiso
                FROM Profesor p
                JOIN Permiso permiso ON p.Num_Control = permiso.Num_Control
                JOIN Dia dia ON permiso.Permiso_ID = dia.Permiso_ID";
    ...
    <table border="1">
        ...
        <?php
            while ($row = oci_fetch_assoc($statement)) {
                ...
                echo "<td>" . $row['APLICA'] . "</td>\n";
                echo "<td>" . $row['FECHA'] . "</td>\n";
                echo "<td>" . $row['RAZON_PERMISO'] . "</td>\n";
                echo "</tr>\n";
            }
        ?>
    </table>
